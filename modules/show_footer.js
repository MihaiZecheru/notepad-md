function show_footnote(ele_id) {
  ...
  const footnotesPlaceholder = document.getElementById("footnotes-alert-placeholder");

  footnotesPlaceholder.innerHTML = `
  ...
  footnotesPlaceholder.childNodes[1].addEventListener("click", () => {
    footnotesPlaceholder.innerHTML = "";
  });
}